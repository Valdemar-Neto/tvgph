    ...
    <div className="max-w-6xl mx-auto p-4 md:p-8 space-y-6">
       ...
       <div>
          ...
          <p className="text-muted-foreground mt-2 max-w-2xl">
             Start a physical meeting agenda and track attendance records at the Team headquarters.
          </p>
       </div>
       <div className="flex gap-3">
         <Link href="/dashboard/presence/report">
           <Button variant="outline" size="sm" className="gap-2">
             <BarChart3 className="h-4 w-4" /> Full Report
           </Button>
         </Link>
